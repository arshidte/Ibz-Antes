 ...
 */
 {
  ...
  class Slide {
    ...
    calcTransforms() {
      ...
      this.transforms = [
        {
          x: -1 * (winsize.width / 4 - this.width / 5),
          y: -1 * (winsize.height / 2 + this.height),
          rotation: -30,
        },
        {
          x: -1 * (winsize.width / 4 - this.width / 5),
          y: -1 * (winsize.height / 3 - this.height / 4),
          rotation: 0,
        },
        { x: -25, y: 70, rotation: 0 },
        {
          x: winsize.width / 4 - this.width / 5,
          y: winsize.height / 3 - this.height / 4 +20,
          rotation: 0,
        },
        {
          x: winsize.width / 2 + this.width,
          y:winsize.height / 3 - this.height / 4 +50,
          rotation: 30,
        },
        {
    ...
    initEvents() {
      ...
      this.mouseleaveFn = (ev) =>
        requestAnimationFrame(() => {
          ...
          TweenMax.to([this.DOM.imgWrap], 1.8, {
            ease: 'Power4.easeOut',
            x: 0,
            y: 0,
            rotationX: 0,
